...
import { GradeLevelEnum, Student, Teacher, TeacherWithProfile, User } from "@/lib/collection.types";
...
const TeacherSubjectComboBox = ({
  ...
  className?: string;
  setTeacherId: Dispatch<SetStateAction<string | null>>;
  currentTeacherName: string;
  gradeLevel: GradeLevelEnum | null | undefined;
}) => {
  ...
  useEffect(() => {
    const fetchAllTeachers = async () => {
      ...
      const { data, error } = await supabase
        .from("teachers")
        .select("*, profiles!teachers_user_id_fkey(*)")
        .eq("grade_level", gradeLevel as GradeLevelEnum);
